...
/**
 * This function extends the navigation with the availability report
 *
...
function report_availability_extend_navigation_course($navigation, $course, $context): void {
    if (has_capability('report/availability:view', $context)) {
        ...
        $navigation->add($txt, $url, navigation_node::TYPE_SETTING, null, null, new pix_icon('i/report', $txt));
    }
}
